...
public class HllSketchMergeComplexMetricSerde extends ComplexMetricSerde {
  ...
  public void deserializeColumn(final ByteBuffer buf, final ColumnBuilder columnBuilder) {
    columnBuilder.setComplexColumnSupplier(
        new ComplexColumnPartSupplier(
            getTypeName(),
            GenericIndexed.read(
                buf, HllSketchObjectStrategy.STRATEGY, columnBuilder.getFileMapper())));
  }
  ...
  static HllSketch deserializeSketch(final Object object) {
    if (object instanceof String) {
      return HllSketch.wrap(
          Memory.wrap(
              DruidStringUtils.decodeBase64(((String) object).getBytes(StandardCharsets.UTF_8))));
    ...
    throw new IAE(
        "Object is not of a type that can be deserialized to an HllSketch:"
  ...
  public GenericColumnSerializer getSerializer(
      final SegmentWriteOutMedium segmentWriteOutMedium, final String column) {
