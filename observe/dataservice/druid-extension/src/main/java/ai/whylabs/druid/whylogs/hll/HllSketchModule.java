...
/**
 * This module is to support count-distinct operations using {@link HllSketch}. See <a
 * href="https://datasketches.apache.org/docs/HLL/HLL.html">HyperLogLog Sketch documentation</a>
 */
public class HllSketchModule implements DruidModule {

  public static final String TYPE_NAME =
      "HLLSketch"; // common type name to be associated with segment data
        ...
        new SimpleModule("HllSketchModule")
            .registerSubtypes(
                ...
                new NamedType(
                    ...
                    ESTIMATE_WITH_BOUNDS_TYPE_NAME),
