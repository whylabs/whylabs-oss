...
/**
 * Returns a distinct count estimate a from a given {@link HllSketch}. The result will be a double
 * value.
 */
public class HllSketchToEstimatePostAggregator implements PostAggregator {
  ...
  public boolean equals(Object o) {
    ...
    return round == that.round && name.equals(that.name) && field.equals(that.field);
  }
