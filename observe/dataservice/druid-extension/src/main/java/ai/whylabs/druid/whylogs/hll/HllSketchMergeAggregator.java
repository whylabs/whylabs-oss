...
public class HllSketchMergeAggregator implements Aggregator {
  ...
  public HllSketchMergeAggregator(
      final ColumnValueSelector<HllSketch> selector, final int lgK, final TgtHllType tgtHllType) {
  ...
  /**
   * This method is synchronized because it can be used during indexing, and Druid can call
   * aggregate() and get() concurrently. See https://github.com/druid-io/druid/pull/3956
   */
  @Override
