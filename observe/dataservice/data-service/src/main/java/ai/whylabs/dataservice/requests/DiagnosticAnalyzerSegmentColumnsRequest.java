...
@Data
public class DiagnosticAnalyzerSegmentColumnsRequest {
  ...
  @JsonPropertyDescription("Required, diagnose within this segment")
  @Schema(required = true)
  ...
  @JsonPropertyDescription("Required, analyzerId")
  @Schema(required = true)
