WITH parameters (orgId, granularity, datasetIds, startTS, endTS, segments, monitorIds, analyzerIds, runIds, includeUnhelpful, granularityInclusion, parentChildScope) as (
...
--             false)
    ...
    values (:orgId,
     ...
     events as (select sum(d.anomaly_count) as anomalies,
                ...
                group by datasetId, metric, timestamp, segment
     )
