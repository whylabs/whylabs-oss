...
export const DigestEmailContent = {
  ...
  alerted_features: [
    {
      ...
      type: 'drift',
      url: `https://observatory.development.whylabsdev.com/models/${config.test.datasetId}/features/${config.test.columnName}?startDate=2022-05-03&endDate=2022-05-16&targetOrgId=${config.test.orgId}`,
    },
  ],
  alerted_segments: [
    {
  ...
  most_recent_anomalies: [
    {
      ...
      type: 'drift',
      weight: null,
      url: `https://observatory.development.whylabsdev.com/models/${config.test.datasetId}/features/${config.test.columnName}?targetOrgId=${config.test.orgId}`,
    },
    {
...
export const EveryAnomalyEmailContent = {
  ...
  feature: 'auth_amount_streak_length_by_browser_fingerprint_from_payment_browser_fingerprint_rehashed',
  granularity: 'DAYS',
  ...
  target_level: 'column',
  type: 'stddev',
  url: 'https://observatory.development.whylabsdev.com/resources/model-1/features/auth_amount_streak_length_by_browser_fingerprint_from_payment_browser_fingerprint_rehashed?targetOrgId=org-gWtdtQ',
  weight: 1,
};
