...
type Events = Pick<ButtonHTMLAttributes<HTMLButtonElement>, 'onClick' | 'onMouseDown' | 'onMouseUp' | 'onMouseMove'>;
...
export const InvisibleButton = ({ className, children, disabled, id, ...rest }: InvisibleButtonProps) => {
