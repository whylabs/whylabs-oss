...
const DogDialogGoBack = (): JSX.Element => {
  ...
  const handleGoBack = () => {
    if (location.state) {
      ...
      // While dependent on ui-exp project we can't use the router here, so we need to do a full page reload to the origin path
...
export default DogDialogGoBack;
