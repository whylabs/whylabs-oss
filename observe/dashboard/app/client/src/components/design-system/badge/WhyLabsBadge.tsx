...
const WhyLabsBadge = ({
  ...
  const showTooltip = displayTooltip || (maxWidth && rect.width >= maxWidth - BADGE_OFFSET);
  return (
    <WhyLabsTooltip label={showTooltip ? overrideTooltip ?? children : ''} position={tooltipPosition} openDelay={300}>
