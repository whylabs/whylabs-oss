...
const presetName = 'Prompt negativity detection (stddev) monitor with trailing window baseline';
const displayName = 'Prompt negativity detection';
const baseConfig = {
  schedule: {
    type: 'fixed',
  ...
  targetMatrix: {
    type: 'column',
    include: ['prompt.sentiment.sentiment_score'],
    exclude: [],
    segments: [],
  },
  config: {
...
const description: JSX.Element = (
  <>
    ...
    negative words in prompt from the target batch differs by more than <pre>factor</pre> standard deviations from the
...
export const promptNegativityStddevTrailingWindowPreset: JsonPreset = {
  displayName,
  baseConfig,
  programmaticChanges,
  presetName,
