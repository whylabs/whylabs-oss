import { createStyles, getStylesRef, Loader, SelectItem } from '@mantine/core';
...
export interface GenericFlexColumnSelectItemData extends React.ComponentPropsWithoutRef<'div'>, SelectItem {
  disabled?: boolean;
  hideIcon?: boolean;
  loading?: boolean;
  ...
  (
    ...
    const element = (
      <div
        ...
        id={others.value ? `item-${others.value}` : undefined}
      >
