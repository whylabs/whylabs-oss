...
const drawerWidthCache = atom<Map<string, ResizerState>>({ default: new Map(), key: 'drawerGlobalCache' });
...
export const WhyLabsDrawer = ({
  ...
  const [widthCache, setWidthCache] = useRecoilState(drawerWidthCache);
