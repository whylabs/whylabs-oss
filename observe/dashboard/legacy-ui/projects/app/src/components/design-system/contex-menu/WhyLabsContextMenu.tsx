import { Menu, MenuProps, Loader } from '@mantine/core';
...
type WhyLabsContextMenuProps = Pick<
  MenuProps,
  'opened' | 'children' | 'onChange' | 'onOpen' | 'onClose' | 'id' | 'styles'
> & {
...
export const WhyLabsContextMenu: React.FC<WhyLabsContextMenuProps> = ({ children, target, items, ...rest }) => {
  ...
  return (
    <div data-testid="WhyLabsContextMenu">
      <Menu shadow="md" {...rest} withinPortal>
