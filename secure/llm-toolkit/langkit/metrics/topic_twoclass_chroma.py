...
) -> ChromaTwoClassVectorDB:
    chroma_db = ChromaTwoClassVectorDB(
        encoder_name,
        stage=stage,
        version=version,
...
def topic_chroma_twoclass_metric(
    column_name: str,
    topic: Labels,
    version: Optional[int] = None,
...
prompt_topic_twoclass_chroma_metric = partial(topic_chroma_twoclass_metric, "prompt")
