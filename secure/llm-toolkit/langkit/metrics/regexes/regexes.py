...
prompt_response_default_regexes_module: MetricCreator = [prompt_default_regexes_enum_metric, response_default_regexes_module]
...
prompt_regex_metric: MetricCreator = [
...
response_regex_metric: MetricCreator = [
...
prompt_response_ssn_regex_module: MetricCreator = [prompt_ssn_regex_metric, response_ssn_regex_metric]
prompt_response_credit_card_number_regex_module: MetricCreator = [
    prompt_credit_card_number_regex_metric,
    response_credit_card_number_regex_metric,
]
prompt_response_phone_number_regex_module: MetricCreator = [prompt_phone_number_regex_metric, response_phone_number_regex_metric]
prompt_response_mailing_address_regex_module: MetricCreator = [prompt_mailing_address_regex_metric, response_mailing_address_regex_metric]
prompt_response_email_address_regex_module: MetricCreator = [prompt_email_address_regex_metric, response_email_address_regex_metric]
prompt_response_url_regex_module: MetricCreator = [prompt_url_regex_metric, response_url_regex_metric]
