...
import { SideNavMenu, SideNavMenuProps } from '~/routes/:resourceId/llm-trace/policy/components/SideNavMenu';
import { SETTINGS_NAV_MENU } from '~/routes/:resourceId/llm-trace/policy/utils';
import { POLICY_RULESETS_NAME } from '~/routes/:resourceId/llm-trace/utils/tabUtils';
...
export const LlmTracePolicyIndex = () => {
  ...
  const navSections: SideNavMenuProps['sections'] = [
    ...
    {
      title: 'SETTINGS',
      items: SETTINGS_NAV_MENU.map((item) => {
        return {
          ...item,
          clickHandler: () => {
    ...
    <div className={classes.root}>
      ...
      <div className={classes.bottomToolbar}>
        ...
        <WhyLabsSubmitButton
          ...
          disabledTooltip={viewModel.isDirty ? 'Not available in the demo org' : undefined}
