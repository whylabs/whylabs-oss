...
const DIMENSION_LIST_CONDITIONS = [
  {
    label: 'Includes',
    value: 'includes',
  },
...
const DIMENSION_NUMBER_CONDITIONS = [
  {
    label: 'Greater than',
    value: '>',
  },
...
describe('useComposedFilter()', () => {
  ...
  describe('Dimension type=list', () => {
      ...
      expect(result.current.filters).toStrictEqual([
        {
          ...
          conditionOptions: DIMENSION_LIST_CONDITIONS,
    ...
    it('should change condition and reset the value', () => {
      const { result } = getHookRenderer({
      ...
      expect(result.current.filters).toStrictEqual([
        {
          ...
          conditionOptions: DIMENSION_NUMBER_CONDITIONS,
