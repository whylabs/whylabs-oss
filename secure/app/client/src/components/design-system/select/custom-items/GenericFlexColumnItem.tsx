        ...
        <>
          {rows.map((r, index) => {
            ...
            if ('textElementConstructor' in r) {
              return (
                <WhyLabsTooltip label={usedRowTooltip}>
                  {/* eslint-disable-next-line react/no-array-index-key */}
                  <div key={`${others.value}-${index}-row`} className={classes.rowWrapper}>
            ...
            return (
              <WhyLabsTooltip label={usedRowTooltip}>
                <div key={element.key ?? `${others.value}-${index}`} className={classes.rowWrapper}>
                  {element}
                </div>
              </WhyLabsTooltip>
            );
